//Objective:  receive inputs about someone from a keyboard, and output the results.
//Name: Robert Loth
...
int main()
{
  ...
  cout << "Objective: This program will receive inputs about someone from a keyboard, and output the results.\n"; 
